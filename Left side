  ...
  (async function() {
    ...
    try {
      ...
      for(let [summaryLevel, blocks] of summaryLevelBlockEntries) {
        ...
        TIP: In order to ensure the summary is half the length of the full text, you should consider what's actually happening in the story at a "higher level", rather than simply re-stating all the individual facts in a terse form. The summary should be a higher-level explanation of the full text.`.trim();
